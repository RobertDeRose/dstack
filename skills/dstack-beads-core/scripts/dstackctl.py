...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Mechanics: stateless deterministic controller for dstack workflows."
    )
    ...
    scaffold_design = mechanical_parser(feature_sub, "scaffold-design", "create a missing design file without overwriting")
    ...
    finish_workstream = mechanical_parser(feature_sub, "finish-workstream", "close the implementation epic when children are complete")
    finish_workstream.add_argument("selector")
    finish_workstream.set_defaults(func=cmd_feature_finish_workstream)
    claim_closeout = mechanical_parser(feature_sub, "claim-closeout", "claim feature closeout after implementation fan-in")
    claim_closeout.add_argument("selector", nargs="?")
    claim_closeout.set_defaults(func=cmd_feature_claim_closeout)
    finish_closeout = mechanical_parser(feature_sub, "finish-closeout", "finish feature closeout and record its summary")
    ...
    alignment_workstream = mechanical_parser(alignment_sub, "finish-workstream", "close the correction epic when children are complete")
    ...
    finish_landing = mechanical_parser(alignment_sub, "finish-landing", "finish alignment landing and record its summary")
