...
secrets, live workflow state, commit identities, worktree paths, or next-command bookkeeping. Setup and doctor enforce
the interaction policy; documentation validation enforces the canonical book.
