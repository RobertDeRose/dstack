...
The controller supports Beads 1.x beginning with 1.2.2. Compatibility is proven
through behavioral acceptance tests, not exact build-string matching.
...
The reviewed task graph adds explicit task-to-audit blockers as a conservative
