...
For current features, `dstack docs export-design` copies that design verbatim from the Beads plan into `design.md`. The
surrounding index remains reader-facing documentation, while exact command syntax, environment behavior, and
