...
Project validation is fixed to `hk check -a` for agent-facing task and audit commands. There is no environment variable
or CLI option that can weaken validation or substitute alternate evidence refs.
