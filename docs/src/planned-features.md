...
| `040-github-validation-and-docs-deployment` — GitHub validation and docs deployment | `dstack-mol-8fe` | implementation | F010, F020   | [Design](features/040-github-validation-and-docs-deployment/design.md) |
...
Continue with `/implement-feature 040-github-validation-and-docs-deployment`; its first ready tasks generate validation,
deployment, and external-gh enablement on disjoint surfaces.
