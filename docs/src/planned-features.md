...
| `monorepo-tooling-layout` — Monorepo tooling layout                             | `dstack-mol-7s4` | implementation | Language quality profiles, hk policy simplification    | [Design](features/monorepo-tooling-layout/design.md)               |
...
Implement `monorepo-tooling-layout` from the delivered simplified and migration-safe policy. GitHub validation and docs
