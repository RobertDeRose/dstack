...
Continue F020 specification review. F010 established truthful setup inputs and documentation structure; F020 adds the
universal tooling baseline independently.
