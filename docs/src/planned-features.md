...
| `monorepo-tooling-layout` — Monorepo tooling layout                             | `dstack-mol-7s4` | close-out     | Language quality profiles, hk policy simplification    | [Design](features/monorepo-tooling-layout/design.md)               |
...
Complete delivery of `monorepo-tooling-layout`. GitHub validation and docs deployment's waived live Pages exercise
