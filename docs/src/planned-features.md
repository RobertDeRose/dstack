...
| Feature                                                                             | Beads root       | Roadmap state | Dependencies |
|-------------------------------------------------------------------------------------|------------------|---------------|--------------|
| `010-purposeful-project-scaffold` — Purposeful project scaffold                     | `dstack-mol-ln9` | delivered     | —            |
| `020-universal-project-tooling` — Universal project tooling                         | `dstack-mol-lg3` | delivered     | —            |
| `030-language-quality-profiles` — Language quality profiles                         | `dstack-mol-ni2` | delivered     | F020         |
| `040-github-validation-and-docs-deployment` — GitHub validation and docs deployment | `dstack-mol-8fe` | design        | F010, F020   |
| `050-monorepo-tooling-layout` — Monorepo tooling layout                             | `dstack-mol-7s4` | blocked       | F030         |
...
Continue with `/start-feature 040-github-validation-and-docs-deployment`; it can now consume the stable generated task
