...
|-------------------------------------------------------------------------------------|------------------|---------------|--------------|------------------------------------------------------------------------|
| `010-purposeful-project-scaffold` — Purposeful project scaffold                     | `dstack-mol-ln9` | spec-review   | —            | [Design](features/010-purposeful-project-scaffold/design.md)           |
...
Start with `/start-feature 010-purposeful-project-scaffold`. F010 establishes truthful setup inputs and documentation
structure while F020 can undergo specification review independently.
