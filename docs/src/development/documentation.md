...
dStack's own documentation follows the same feature-publication pattern that dStack provides to other repositories. The
mdBook under `docs/` is the current product documentation; accepted feature designs are preserved under
