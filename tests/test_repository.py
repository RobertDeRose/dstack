...
REQUIRED_SKILL_SUPPORT = (
    ...
    "skills/dstack-core/scripts/append-review-note.py",
    "skills/dstack-core/scripts/build-beads-review-projection.py",
    "skills/dstack-core/scripts/promote-legacy-feature.py",
...
def test_migration_question_contract(repository_root: Path) -> None:
    ...
    assert "inspect current reader-facing docs" in normalized
    assert "recommended answer" in section
    assert "accept recommendation" in section
