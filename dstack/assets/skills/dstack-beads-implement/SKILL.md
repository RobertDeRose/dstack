...
Change into the returned worktree and verify the active branch matches the returned `feat/<slug>` branch. Run
`bd prime --mcp` after a new session or context compaction when a compact Beads reminder is useful.
